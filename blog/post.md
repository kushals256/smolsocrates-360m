...
I used the [PACT dataset](https://huggingface.co/datasets/AndreiSobo/PACT-Socratic-Coding-Tutor) augmented with synthetic examples generated by Llama 3 — resulting in nearly 300 high-quality examples of Socratic coding dialogue. Each example pairs a realistic student coding error with guiding questions instead of direct solutions.

300 examples might sound tiny, but that's the point. With LoRA, you don't need thousands of examples to teach a model a specific behavior pattern.
...
- **LoRA rank**: 32 (trains ~4% of parameters)
